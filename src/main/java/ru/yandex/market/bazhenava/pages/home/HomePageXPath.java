...
public class HomePageXPath {
    ...
    public static final String LINK_FOR_CUSTEM_DOWN_SITE =
            "//div[@id='/content/footer']/div/footer/noindex/div[3]/div/div/div";
    ...
    public static final String LOGO_SITE_NAME = "Яндекс";
    public static final String CORRECT_LINK_LOGIN_DATE = "Мы в соцсетях";
    public static final String BIN_NAME = "Корзина";
    public static final String LINKS_FOR_CUSTEMER =
            "Покупателям\n" +
                    "Как выбрать товар\n" +
                    "Оплата и доставка\n" +
                    "Обратная связь\n" +
